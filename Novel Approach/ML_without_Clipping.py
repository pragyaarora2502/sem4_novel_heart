...
data = pd.read_csv("Features_without_clips.csv")
...
pickle.dump(forest, open("no_clips_layer_1_RF.sav", 'wb'))
...
pickle.dump(gradient, open("no_clips_layer_1_GB.sav", 'wb'))
...
pickle.dump(forest, open("no_clips_layer_2_RF.sav", 'wb'))
...
pickle.dump(gradient, open("no_clips_layer_2_GB.sav", 'wb'))
